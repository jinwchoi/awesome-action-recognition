...
* [Learning Spatiotemporal Features with 3D Convolutional Networks](http://vlg.cs.dartmouth.edu/c3d/c3d_video.pdf) - D. Tran et al, ICCV2015. [[the official Caffe code]](https://github.com/facebook/C3D) [[project web]](http://vlg.cs.dartmouth.edu/c3d/) Note: Aka C3D. [[TensorFLow]](https://github.com/hx173149/C3D-tensorflow), [[TensorFlow + Keras]](https://github.com/axon-research/c3d-keras), [[Keras]](https://gist.github.com/albertomontesg/d8b21a179c1e6cca0480ebdf292c34d2), [[A model pretrained on Sports1M for Keras]](https://imatge.upc.edu/web/resources/c3d-model-keras-trained-over-sports-1m)
